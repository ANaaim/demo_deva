...
def plateforme_extraction(acq):
    ...
    for ind_plateform in range(nb_plateform):
        ...
        corner_1 = np.array(corners[:,0,ind_plateform])
        corner_2 = np.array(corners[:,1,ind_plateform])
        corner_3 = np.array(corners[:,2,ind_plateform])
        corner_4 = np.array(corners[:,3,ind_plateform])
        ...
        # FIXME : modify the value of the signe
